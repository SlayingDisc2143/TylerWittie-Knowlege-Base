...
So an RTX 5070 TI would be a Gaming oriented (RTX) from the 50 series generation with a performance rating of 70 (High performance) .The TI stands for an enhanced version of the card prior (RTX 5090). 
### AMD GPUs
